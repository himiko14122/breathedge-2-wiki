// Cloudflare Worker entry for Breathedge 2 Wiki
...
async function handleIndexNow(request) {
  ...
  if (request.method === 'GET') {
    ...
    const locales = ['en', 'ru', 'es', 'ja'];
    const categories = [
      'guides', 'updates', 'gameplay', 'crafting', 'spaceships',
      'crew', 'story', 'technical', 'comparisons',
    ];
    const allUrls = [];
