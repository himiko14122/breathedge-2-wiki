...
export default async function CatchAllPage({ params }: { params: Promise<{ locale: string; slug: string[] }> }) {
  ...
  if (isContentType(first)) {
    ...
    const GUIDE_STOP_WORDS = new Set(['breathedge', 'breathing', 'edge', '2', 'space', 'survival', 'guide', 'guides', 'early', 'access', 'release', 'craft', 'crafting', 'crew', 'ship', 'spaceship', 'spaceships', 'vehicle', 'vehicles', 'gameplay', 'story', 'technical', 'comparison', 'comparisons', 'update', 'updates', 'demo', 'wiki', 'complete', 'ultimate', 'best', 'build', 'tips', 'walkthrough', 'the', 'a', 'an', 'and', 'or', 'in', 'on', 'at', 'to', 'for', 'is', 'it', 'how', 'what', 'all', 'vs', 'game']);
