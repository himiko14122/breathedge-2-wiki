...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    keywords: ['Breathedge 2 Wiki', 'Breathedge 2 about', 'Breathedge 2 community wiki', 'Breathedge 2 fan wiki', 'Breathedge 2 survival space simulator'],
  };
}
      ...
      <section className="mb-10">
        ...
        <div className="card mb-6">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            ...
            <a href={EXTERNAL_LINKS.discord} target="_blank" rel="noopener noreferrer" title={t('about_joinDiscord')} className="card text-center hover:border-[var(--color-accent)] transition-colors">
              <span className="text-2xl mb-2 block">💬</span>
            ...
            <a href={EXTERNAL_LINKS.youtube} target="_blank" rel="noopener noreferrer" title={t('about_watchYouTube')} className="card text-center hover:border-[var(--color-accent)] transition-colors">
              <span className="text-2xl mb-2 block">📺</span>
