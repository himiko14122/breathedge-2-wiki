...
// Breathedge 2 native banner
export const NATIVE_SLOT: NativeSlot = {
  type: 'native-banner',
  containerId: 'container-7ec36d3d5a973ed15bda98d77a45d1ca',
  scriptUrl: '//pl30889854.effectivecpmnetwork.com/7ec36d3d5a973ed15bda98d77a45d1ca/invoke.js',
};
...
// client saw undefined → hydration mismatch → ads never rendered client-side). 2026-08-15.
